...
public class MyUtil {
    ...
    public static void displayPatient(ArrayList<Patient> patientList) {
        int count = 1;
        ...
        for (Patient list : patientList) {
            System.out.printf("|%-5d|%-10s|%-15s|%-15s|%-15s|%-15s|\n", count++, list.getId(), simpleDateFormat.format(list.getAdmissionDate()), list.getName(), list.getPhone(), list.getDiagnosis());
        }
        System.out.println("+-----+----------+---------------+---------------+---------------+---------------+");
    }
}
